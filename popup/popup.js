 document.addEventListener('DOMContentLoaded', function() {
        ...
        const viewPhotoButton = document.getElementById('view-photo-button'); // Add reference to the View Photo button
        ...
        uploadButton.addEventListener('click', async function() {
            ...
            try {
                ...
                if (file.type.startsWith('image/')) {
                    ...
                    console.log("Uploaded file URL: ", uploadedFileUrl); // Debugging line to check the URL
                }
        ...
        // Add event listener for the "View Photo" button
        viewPhotoButton.addEventListener('click', function() {
            console.log("View photo clicked!"); // Debugging line
            // Clear status message before showing the image
            showStatus(''); // Clear the status message to make space for the image
